...
(function () {
  ...
  var ICONS = {
    ...
    captions:
      '<svg viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="8" width="32" height="22" rx="3"/><line x1="10" y1="24" x2="30" y2="24"/><line x1="10" y1="19" x2="22" y2="19"/></svg>',
    thumbnail:
  ...
  if (!services.length) {
    if (emptyState) {
      ...
      emptyState.textContent = sectionCfg.emptyStateText || "No services listed yet.";
    }
    return;
  }
